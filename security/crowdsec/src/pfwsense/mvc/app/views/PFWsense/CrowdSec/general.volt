...
<div class="content-box tab-content">
    <div id="introduction" class="tab-pane fade in active">
        ...
        <p>Out of the box, by enabling them in the "Settings" tab, they can protect the PFWsense server
        by receiving thousands of IP addresses of active attackers, which are immediately banned at the
        firewall level. In addition, the logs of the ssh service and PFWsense administration interface are
        ...
        <p>Other attack behaviors can be recognized on the PFWsense server and its plugins, or
	...
	and us to have better overall metrics.
        ...
        href="https://docs.crowdsec.net/docs/next/getting_started/install_crowdsec_pfwsense">Install
        CrowdSec (PFWsense)</a></p>

        <p>A few remarks:</p>

        <ul>
            <li>
                New acquisition files go under <code>/usr/local/etc/crowdsec/acquis.d</code>. See pfwsense.yaml for details.
                The option <code>poll_without_inotify: true</code> is required if the acquitision targets are symlinks (which
                is the case for most pfwsense logs).
            </li>
            <li>
                If your PFWsense is &lt;22.1, you must check "Disable circular logs" in the Settings menu for the
                ssh and web-auth parsers to work. If you upgrade to 22.1, it will be done automatically.
                See <a href="https://github.com/crowdsecurity/pfwsense-plugin-crowdsec/blob/main/src/etc/crowdsec/acquis.d/pfwsense.yaml">acquis.d/pfwsense.yaml</a>
            </li>
            <li>
                At the moment, the CrowdSec package for PFWsense is fully functional on the
            ...
            <li>
                ...
                <a href="https://hub.crowdsec.net/author/crowdsecurity/collections/pfwsense">crowdsecurity/pfwsense</a>
	...
	<pre><code>[root@PFWsense ~]# cscli decisions add -t ban -d 2m -i &lt;your_ip_address&gt;</code></pre>
