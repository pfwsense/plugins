...
# apply configuration options specific to pfwsense
/usr/local/pfwsense/scripts/PFWsense/CrowdSec/reconfigure.py
...
/usr/local/pfwsense/scripts/PFWsense/CrowdSec/hub-upgrade.sh
...
# left from v0.0.8
rm -f /usr/local/etc/crowdsec/pfwsense-settings.json
