...
Telemetry tools, depends on `rule-updater.config`, which contains the device registration number provided by PFWsense.
...
General
----------------
All scripts described in the readme are available in the directory `src/pfwsense/scripts/etpro_telemetry`


Requirements
--------------

Install requirements (default available on PFWsense)
