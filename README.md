About the PFWsense plugins
==========================

The plugins collection offers users and developers a way to quickly
build additions for PFWsense that can be optionally installed.  As
...
at project AT pfwsense DOT org or open GitHub issue to get in touch.
...
emulators/qemu-guest-agent -- QEMU Guest Agent for PFWsense
...
When an PFWsense release is built, the plugins are automatically
