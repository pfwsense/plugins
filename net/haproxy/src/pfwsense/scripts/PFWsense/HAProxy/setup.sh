...
# NOTE: Keep /var/haproxy on this list, see GH issue pfwsense/plugins #39.
...
/usr/local/pfwsense/scripts/PFWsense/HAProxy/exportCerts.php > /dev/null 2>&1
/usr/local/pfwsense/scripts/PFWsense/HAProxy/exportLuaScripts.php > /dev/null 2>&1
/usr/local/pfwsense/scripts/PFWsense/HAProxy/exportErrorFiles.php > /dev/null 2>&1
/usr/local/pfwsense/scripts/PFWsense/HAProxy/exportMapFiles.php > /dev/null 2>&1

# update OCSP data
if [ "${haproxy_ocsp}" == "YES" ]; then
  /usr/local/pfwsense/scripts/PFWsense/HAProxy/updateOcsp.sh > /dev/null 2>&1
fi
